const translations = {
  ...
  '拒绝': 'Deny',
  '记住…': 'Remember…',
  '保存一条规则，以后匹配的操作不再询问': 'Save a rule so matching operations no longer ask',
  '始终允许命令': 'Always allow command',
  '始终允许文件夹': 'Always allow folder',
  '命令模式': 'Command pattern',
  '文件夹路径': 'Folder path',
  '访问': 'Access',
  '只读': 'Read only',
  '读写': 'Read & write',
  '* 匹配任意内容。删除类和危险命令始终会询问。': '* matches anything. Delete and other risky commands always ask.',
  '该文件夹及其子文件夹。删除操作始终会询问。': 'This folder and everything inside it. Deleting always asks.',
  '保存并允许': 'Save & allow',
  '取消': 'Cancel',
  '规则已保存：{pattern}': 'Rule saved: {pattern}',
  '你': 'You',
  '已打断': 'Interrupted',
  '来源': 'Sources',
  '打开 {label}': 'Open {label}',
  ...
  '试着说': 'Try saying',
  '“帮我查一下今天的 AI 新闻，并整理成三点摘要。”': '“Find the largest files in my Footage folder and list the top five.”',
