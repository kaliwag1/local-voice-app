...
import { computerUseMcpServer as computerUseDescriptor } from '../../../../../shared/backend/computer-use.mjs'
...
export {
  computerUseRuntime,
  settingEnabled,
} from '../../../../../shared/backend/computer-use.mjs'

export function computerUseMcpServer(env = process.env, runtimeOptions = {}) {
  const descriptor = computerUseDescriptor(env, runtimeOptions)
